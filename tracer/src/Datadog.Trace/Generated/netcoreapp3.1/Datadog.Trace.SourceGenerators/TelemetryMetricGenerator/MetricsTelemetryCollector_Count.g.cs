...
internal partial class MetricsTelemetryCollector
{
    ...
    private static AggregatedMetric[] GetCountBuffer()
        => new AggregatedMetric[]
        {
            ...
            new(new[] { "config.datadog:DD_TRACE_DEBUG", "config.opentelemetry:OTEL_LOG_LEVEL" }),
            new(new[] { "config.datadog:DD_TRACE_DEBUG", "config.opentelemetry:OTEL_METRICS_EXPORTER" }),
            new(new[] { "config.datadog:DD_TRACE_DEBUG", "config.opentelemetry:OTEL_PROPAGATORS" }),
            new(new[] { "config.datadog:DD_TRACE_DEBUG", "config.opentelemetry:OTEL_RESOURCE_ATTRIBUTES" }),
            new(new[] { "config.datadog:DD_TRACE_DEBUG", "config.opentelemetry:OTEL_SDK_DISABLED" }),
            new(new[] { "config.datadog:DD_TRACE_DEBUG", "config.opentelemetry:OTEL_SERVICE_NAME" }),
            new(new[] { "config.datadog:DD_TRACE_DEBUG", "config.opentelemetry:OTEL_TRACES_EXPORTER" }),
            new(new[] { "config.datadog:DD_TRACE_DEBUG", "config.opentelemetry:OTEL_TRACES_SAMPLER" }),
            new(new[] { "config.datadog:DD_TRACE_DEBUG", "config.opentelemetry:OTEL_TRACES_SAMPLER_ARG" }),
            new(new[] { "config.datadog:DD_TRACE_DEBUG", "config.opentelemetry:Unknown" }),
